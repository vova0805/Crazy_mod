...
import net.mcreator.crazymod.item.AncientfossilsItem;
...
public class StonewithancientfossilsBlock extends CrazyModModElements.ModElement {
	@ObjectHolder("crazy_mod:stonewithancientfossils")
	public static final Block block = null;

	public StonewithancientfossilsBlock(CrazyModModElements instance) {
		super(instance, 2);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stonewithancientfossils");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AncientfossilsItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("crazy_mod:stonewithancientfossils_match"),
