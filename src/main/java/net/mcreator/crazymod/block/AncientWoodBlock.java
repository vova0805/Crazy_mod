...
public class AncientWoodBlock extends CrazyModModElements.ModElement {
	@ObjectHolder("crazy_mod:ancient_wood")
	public static final Block block = null;

	public AncientWoodBlock(CrazyModModElements instance) {
		super(instance, 11);
	}
