...
public class AncientSlabBlock extends CrazyModModElements.ModElement {
	@ObjectHolder("crazy_mod:ancient_slab")
	public static final Block block = null;

	public AncientSlabBlock(CrazyModModElements instance) {
		super(instance, 16);
	}
