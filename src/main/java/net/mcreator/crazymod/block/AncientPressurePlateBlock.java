...
public class AncientPressurePlateBlock extends CrazyModModElements.ModElement {
	@ObjectHolder("crazy_mod:ancient_pressure_plate")
	public static final Block block = null;

	public AncientPressurePlateBlock(CrazyModModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("ancient_pressure_plate");
		}
