...
public class AncientFenceGateBlock extends CrazyModModElements.ModElement {
	@ObjectHolder("crazy_mod:ancient_fence_gate")
	public static final Block block = null;

	public AncientFenceGateBlock(CrazyModModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("ancient_fence_gate");
		}
