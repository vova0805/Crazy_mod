...
public class AncientLogBlock extends CrazyModModElements.ModElement {
	@ObjectHolder("crazy_mod:ancient_log")
	public static final Block block = null;

	public AncientLogBlock(CrazyModModElements instance) {
		super(instance, 12);
	}
