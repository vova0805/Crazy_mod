...
public class AncientStairsBlock extends CrazyModModElements.ModElement {
	@ObjectHolder("crazy_mod:ancient_stairs")
	public static final Block block = null;

	public AncientStairsBlock(CrazyModModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ancient_stairs");
		}
