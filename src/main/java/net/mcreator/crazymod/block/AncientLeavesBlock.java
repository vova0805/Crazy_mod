...
public class AncientLeavesBlock extends CrazyModModElements.ModElement {
	@ObjectHolder("crazy_mod:ancient_leaves")
	public static final Block block = null;

	public AncientLeavesBlock(CrazyModModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("ancient_leaves");
		}
