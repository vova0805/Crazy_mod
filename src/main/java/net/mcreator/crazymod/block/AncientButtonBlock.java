...
public class AncientButtonBlock extends CrazyModModElements.ModElement {
	@ObjectHolder("crazy_mod:ancient_button")
	public static final Block block = null;

	public AncientButtonBlock(CrazyModModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("ancient_button");
		}
