...
public class AncientFenceBlock extends CrazyModModElements.ModElement {
	@ObjectHolder("crazy_mod:ancient_fence")
	public static final Block block = null;

	public AncientFenceBlock(CrazyModModElements instance) {
		super(instance, 17);
	}
