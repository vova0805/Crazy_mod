...
package net.mcreator.crazymod.world.biome;
...
import net.mcreator.crazymod.block.GrassdinoBlock;
import net.mcreator.crazymod.CrazyModModElements;

import com.google.common.collect.ImmutableList;

@CrazyModModElements.ModElement.Tag
public class Dino1Biome extends CrazyModModElements.ModElement {
	public static Biome biome;

	public Dino1Biome(CrazyModModElements instance) {
		super(instance, 8);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-16750849).setWaterFogColor(329011)
				...
				event.getRegistry().register(biome.setRegistryName("crazy_mod:dino_1"));
			}
		}
	}
