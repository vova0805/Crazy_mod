...
package net.mcreator.crazymod.entity.renderer;
...
import net.mcreator.crazymod.entity.TigerZubEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class TigerZubRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TigerZubEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelTigerZub(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("crazy_mod:textures/entities/texturetiger.png");
					}
				};
			});
		}
